...
```bash
# Merge an OpenSpec change
/opsx:merge-pr c0005-llm-profiling-inspector

# Merge with a custom title
/opsx:merge-pr c0005-llm-profiling-inspector --title "feat: add LLM profiling pipeline"
...
- The workflow does NOT archive the OpenSpec change — run `/opsx:archive <change>` after merge.
